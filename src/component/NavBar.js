      ...
      <Navbar bg="light" expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            ...
            {user && (
              <Nav.Link as={Link} to="/finstatement">
                Accounts
              </Nav.Link>
            )}
            {user && (
            ...
            <NavDropdown title="Category" id="basic-nav-dropdown">
              ...
              <NavDropdown.Item as={Link} to="/category/News">
                News
              </NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/category/Opinion">
                Opinion
              </NavDropdown.Item>
              {/* <NavDropdown.Divider />
        <NavDropdown.Item href="#action/3.4">Separated link</NavDropdown.Item> */}
          ...
          <Nav className="ml-auto">{user && <SignOut />}</Nav>
        </Navbar.Collapse>
      </Navbar>
    </div>
  );
